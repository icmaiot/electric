...
@Component({
  selector: 'app-personal-materiales',
  templateUrl: './personal-materiales.component.html',
  styleUrls: ['./personal-materiales.component.scss']
})
export class PersonalMaterialesComponent implements OnInit {
